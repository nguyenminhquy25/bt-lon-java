...
public class Rectangular extends JPanel {
	...
	public boolean checkPointInRectangular(Point point) {
		return point.getX() >= this.getPoints()[0].getX()*100 && point.getX() <= this.getPoints()[1].getX()*100
				&& point.getY() >= this.getPoints()[0].getY()*100 && point.getY() <= this.getPoints()[3].getY()*100
				&& point.getZ() >= this.getPoints()[0].getZ()*100 && point.getZ() <= this.getPoints()[4].getZ()*100;
	}
