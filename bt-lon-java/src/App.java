...
public class App {
    ...
    public static double getRange2Point(Point p1, Point p2) {
        return round(Math.sqrt((p1.getX() - p2.getX()) * (p1.getX() - p2.getX()) + (p1.getY() - p2.getY()) * (p1.getY() - p2.getY()) +
    ...
    public static boolean checkPointInCameraRange(Camera camera, Point point) {
        ...
        return round(getRange2Point(projectionXZ, point) / getRange2Point(camera, projectionXZ)) <= Math.tan(camera.getWideAngle() / 2)
        && round(getRange2Point(projectionXY, point) / getRange2Point(camera, projectionXY)) <= Math.tan(camera.getHighAngle() / 2);
    }
